...
- **Several bookings at once.** Tick them in the bookings list, then click **Message** in the bar that appears. Anyone without the contact method you chose is skipped.
- **From Contacts.** Tick the clients you want and click **Message**, or open one client and use **Send a message**. Everything shows in that client's **Message log**.
