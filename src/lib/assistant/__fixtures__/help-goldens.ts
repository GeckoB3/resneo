...
export const HELP_GOLDENS: HelpGolden[] = [
  ...
  // Venue collectives (plan §6.12, W13): the answer depends on whether the venue hosts or joins.
  { id: 41, question: 'How do I put my two salons on one booking page?', expect: 'cite', articles: ['getting-started/venue-collectives'] },
  {
    id: 42,
    question: 'How do I change the price of a haircut?',
    expect: 'cite',
    articles: ['getting-started/venue-collectives', 'getting-started/services', 'appointments/services'],
    context: { collective: { name: 'Northside', role: 'member', sharedServices: true } },
    mustSay: ['host'],
    note: 'A member cannot change a shared service: the host sets its price for every venue.',
  },
  {
    id: 43,
    question: 'How do I change the price of a haircut at every venue?',
    expect: 'cite',
    articles: ['getting-started/venue-collectives', 'getting-started/services', 'appointments/services'],
    context: { collective: { name: 'Northside', role: 'host', sharedServices: true } },
    mustNotSay: ['ask the host', 'ask your host'],
    note: 'The host saves the service once and the change reaches every venue.',
  },
  {
    id: 44,
    question: 'Why can clients not book my nails service any more?',
    expect: 'cite',
    articles: ['getting-started/venue-collectives', 'getting-started/services'],
    context: { collective: { name: 'Northside', role: 'member', sharedServices: true } },
    mustSay: ['parked'],
    note: 'A member service that is not on the collective page is parked while the collective is live.',
  },
  {
    id: 45,
    question: 'Can I move a booking to a stylist at our other venue?',
    expect: 'cite',
    articles: ['getting-started/venue-collectives'],
    context: { collective: { name: 'Northside', role: 'member', sharedServices: true } },
  },
  {
    id: 46,
    question: 'Why does my booking link open a different page?',
    expect: 'cite',
    articles: ['getting-started/venue-collectives', 'getting-started/public-booking-page'],
    context: { collective: { name: 'Northside', role: 'member', sharedServices: true } },
    mustSay: ['Northside'],
    note: 'Own page hands over to the collective page while it is live (D3).',
  },
];
