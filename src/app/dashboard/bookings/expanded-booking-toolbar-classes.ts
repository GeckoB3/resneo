...
export const EXP_BOOKING_ATTEND =
  `${EXP_BOOKING_BTN} focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-offset-white focus-visible:ring-violet-400/40 font-semibold border border-violet-900/35 bg-violet-600 text-white hover:bg-violet-700`;
