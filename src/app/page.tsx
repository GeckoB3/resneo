          ...
          <div className="text-center lg:text-left">
            ...
            <HomeReveal delay={150}>
              <p className="mx-auto mt-6 max-w-xl text-base leading-relaxed text-slate-600 sm:text-lg lg:mx-0">
                Resneo is the simple, all-in-one booking platform for busy businesses. Fill your diary, automate every reminder, and get paid up front, all without the admin.
              </p>
            </HomeReveal>
