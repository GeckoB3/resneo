-- Collective engine, part 9: the invariant report (Docs/collective-one-venue-plan.md Appendix D
-- `collective_invariant_report`; test plan §4).
--
-- Read-only. One row per invariant: its id, how many rows break it, and up to 20 sample ids to repair.
-- pgTAP, the collective-verify cron, the migration script and every deploy step read the same SQL.
-- p_since bounds the booking and membership checks (NULL: all time); p_collective_id narrows to one
-- collective and its venues (NULL: every collective).
--
-- Built here: I1, I2, I3, I3b, I5, I6, I7, I8, I10, I11, I12, I13, I14, I15, I16, I21, I22, I23, I24,
-- I30, I32, I33, I34, I35, I36, I39, I40, I43, I44. Not yet: I4, I37, I38, I45 and P1 to P5 (the
-- legacy-provider and migration checks, built with the migration script), I41, I42, I46, I47, I48.
--
-- Where the test plan's SQL disagrees with the engine as built, the engine wins and the row says so:
--   * I5, I8, I10, I23 and I32 count live links only (released_at IS NULL). The test plan's text
--     would count every released link, which is kept on purpose for a reconnect (RT2-27).
--   * I15 counts a member's own SERVICE using a managed group or form. A member's venue-wide
--     requirement for a managed form is allowed by the lock (20270216120000), following D10's
--     "member venue-wide forms apply on top"; the test plan's I15 would count it. Owner to confirm.
