...
export const metadata: Metadata = {
  title: 'Customer Terms - ReserveNI',
  description:
          ...
          <div className="space-y-8 text-sm leading-relaxed text-slate-700">
            ...
            <section>
              ...
              <p>
                ...
                &ldquo;your&rdquo;) when you sign up for, subscribe to, or use the ReserveNI platform as a
                business customer. They form a binding contract between you and JAR 26 LTD trading as ReserveNI
                (&ldquo;ReserveNI&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;).
              </p>
              <p className="mt-3">
                By completing sign-up, ticking the acceptance checkbox, or accessing the ReserveNI platform, you
              ...
              <p className="mt-3">
                ...
                Customer Terms take priority for your use of the paid ReserveNI platform.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Your subscription gives you access to the ReserveNI platform features included in the plan you
            ...
            <section>
              ...
              <p>You must use the ReserveNI platform only for lawful purposes. You must not:</p>
            ...
            <section>
              ...
              <p>
                You retain ownership of all data you upload to or generate through the ReserveNI platform,
            ...
            <section>
              ...
              <p>
                The ReserveNI platform, software, branding, trade names, logos, designs, documentation, and all
            ...
            <section>
              ...
              <p className="mt-3">
                ...
                in connection with these Terms or your use of the ReserveNI platform.
              </p>
              <p className="mt-3">
            ...
            <section>
              ...
              <p>
                ...
                Privacy Policy, and Data Processing Agreement, form the entire agreement between you and ReserveNI
