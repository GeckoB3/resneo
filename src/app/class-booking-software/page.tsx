  ...
  "@graph": [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Studios & classes", item: `${SITE_ORIGIN}${PAGE_PATH}` },
      ],
    },
    {
      "@type": "FAQPage",
...
function Hero() {
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-tr from-brand-50 via-white to-accent-50/60" />
      <div
      ...
      <div className="relative rounded-[2.25rem] border border-slate-200 bg-slate-900 p-2 shadow-2xl shadow-brand-900/20">
        <div className="relative overflow-hidden rounded-[1.85rem] bg-white">
          ...
          <div className="px-5 pb-6 pt-4">
            ...
            <p className="mt-2 text-lg font-bold text-slate-900">Vinyasa Flow · Studio One</p>
