...
| `service-categories-plan.md` | Implemented on staging 2026-09-02 (categories on the Services page, grouped booking pages with a category menu or collapsible headings; combined pages inherit headings from member venues). Migrations `20270202120000_service_categories.sql` and `20270202130000_collective_service_categories.sql` are owed to both environments; the code tolerates their absence |
