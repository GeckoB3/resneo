...
// Google's official "Get it on Google Play" web badge (generic English variant).
const GOOGLE_PLAY_BADGE =
  'https://play.google.com/intl/en_us/badges/static/images/badges/en_us_badge_web_generic.png';
...
function AndroidGlyph() {
  return (
    <svg viewBox="0 0 576 512" width="14" height="14" fill="currentColor" aria-hidden>
            ...
            <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center lg:justify-start">
              ...
              >
                <img
                  ...
                  width={168}
                  height={65}
                  style={{ width: 168, height: 65, objectFit: 'contain' }}
                />
              </a>
            </div>
          </div>
