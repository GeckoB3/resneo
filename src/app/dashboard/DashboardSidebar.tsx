 ...
 *
 * **Admin only:** Dining Availability (`/dashboard/availability`), Reports and Refer & Earn (Settings tabs). Matches redirects on those pages.
...
const MODEL_NAV_ITEMS: Partial<Record<BookingModel, NavItem[]>> = {
  ...
  event_ticket: [
    { href: '/dashboard/event-manager', label: 'Events', icon: TicketIcon },
  ],
  class_session: [
    { href: '/dashboard/class-timetable', label: 'Classes', icon: AcademicCapIcon },
  ],
  resource_booking: [
    { href: '/dashboard/resource-timeline', label: 'Resources', icon: CubeIcon },
  ],
};
...
/** Events — distinct from the shared CalendarIcon for sidebar wayfinding (F1). */
...
/** Classes — distinct from the shared CalendarIcon for sidebar wayfinding (F1). */
...
/** Resources — distinct from the shared CalendarIcon for sidebar wayfinding (F1). */
