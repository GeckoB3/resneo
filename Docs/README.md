...
| `rotating-schedule-plan.md` | Implemented on staging 2026-09-02 (a calendar's hours can differ week by week, set on the Availability tab; resolved in `calendarHours`). Migration `20270203120000_calendar_working_hours_rota.sql` is owed to both environments |
