...
6. **Breaks are a veto in the appointment engine and a subtraction in the resource engine.** Veto at `appointment-engine.ts:667-672` and `:1032-1034`; subtraction at `resource-booking-engine.ts:229-231`.
