...
export function renderReferralCreditedEmail(
  ...
  const mainContent = [
    `<p style="margin:0 0 12px">Great news — <strong>${safeReferee}</strong> just signed up to ReserveNI using your referral code, and their first month has been paid.</p>`,
    `<p style="margin:0 0 12px">As a thank-you, we&rsquo;ve added a <strong>${safeReward} credit</strong> to your ReserveNI account. It will be applied automatically to your next invoice.</p>`,
  ...
  const html = renderBaseTemplate({
    ...
    footerNote:
      'You received this email because someone signed up to ReserveNI using your referral code.',
  });

  const text = [
    `Great news — ${params.refereeVenueName} just signed up to ReserveNI using your referral code, and their first month has been paid.`,
    '',
    `As a thank-you, we've added a ${params.rewardDisplay} credit to your ReserveNI account. It will be applied automatically to your next invoice.`,
    '',
