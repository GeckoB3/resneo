...
|------|----------------|-------|---------------------------|----------------------|
| Bookings | `PATCH /api/venue/bookings/[id]`, `.../validate-appointment-modification`, `.../check-in`, `/api/venue/visits/[id]/schedule` and `/services` | Allowed (venue) | Same as admin: any booking, moved to any calendar at the venue (owner's rule, 2026-09-17, replacing C8's own-venue limit) | Same as admin |
